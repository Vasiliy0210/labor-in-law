<?php
  ...
  function send() {
    ...
    $subject  = "New message from Ovcharov landing Labor";
    ...
    $msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #000;padding-bottom:10px;'>Ovcharov message Labor</h2>\r\n";
